    ...
    return <main className="flex min-h-screen min-w-screen flex-col items-center pt-24 bg-primary dark:bg-dark">
     <div className="font-superRetro italic flex flex-col sm:flex-row sm:items-start items-center w-full">
        <div className="sm:flex-col sm:flex sm:w-1/2">
            <div className="sm:max-h-screen sm:w-full flex flex-col items-center justify-between bg-zinc-900 p-8 sm:p-24">
                <Link className="sm:min-h-2/3 flex flex-col relative items-center sm:justify-center w-full cursor-pointer" href='/project/portraits'>
                    <Image placeholder='blur' className="sm:object-contain" src={placeholderMiriam} alt='woman drinking from glass'></Image>
