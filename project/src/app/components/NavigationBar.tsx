...
export default function NavigationBar() {
    ...
    return <>
        <div className="hidden sm:flex flex-row w-full top-0 right-0 absolute z-10 py-6 px-6 justify-between bg-gradient-to-b from-blue-500">
            <Link 
                onClick={handleClose} 
                key={'/'}
                className='px-2 whitespace-nowrap transition-all duration-600 md:hover:text-slate-300'
                href={'/'}
            >
                <motion.p
